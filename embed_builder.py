# ============================================================
# EMBED_BUILDER.PY - PAINEL MODERNO v5.0
# ============================================================
...
MODERN_COLORS = [
    ...
    {"name": "Verde Militar", "emoji": "🌲", "value": 0x4CAF50},
    {"name": "Coral", "emoji": "🪸", "value": 0xFF6B6B},
]


# ============================================================
# EMOJIS E ÍCONES MODERNOS
# ============================================================
...
def is_valid_image_url(url: str) -> bool:
    ...
    url_lower = url.lower()
    return any(url_lower.endswith(ext) for ext in image_extensions) or 'imgur.com' in url_lower
...
def extract_image_info(url: str) -> dict:
    ...
    return {
        ...
        "extension": url.split('.')[-1].lower() if '.' in url else 'unknown'
    }
...
class MapWithImageModal(Modal):
    ...
    def __init__(self, panel_view, option_index: Optional[int] = None, 
        ...
        self.image_input = TextInput(
            label="🖼️ URL da Imagem (opcional)",
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        if image and not is_valid_image_url(image):
            return await interaction.response.send_message(
                "❌ URL de imagem inválida! Use PNG, JPG, GIF, WEBP ou links do Imgur.",
                ephemeral=True
            )
...
class ColorPickerView(View):
    def __init__(self, parent_view):
        ...
        # Adiciona botões de cores em grid
    ...
    def build_options_embed(self) -> discord.Embed:
        ...
        if self.options:
            ...
            for i, opt in enumerate(self.options, 1):
                ...
                map_text.append(f"`{i:02d}` {emoji} **{name}** {has_image}")
...
class OptionsPanelView(View):
                    ...
                    for i, opt in enumerate(self.parent_view.options):
                        ...
                        options.append(
                            SelectOption(
                                ...
                                value=str(i),
                                emoji=emoji,
                                description=f"Clique para editar"
                            )
                        )
                        if len(options) >= 25:
                            break
    ...
    async def add_stumble_maps(self, interaction: discord.Interaction, button: Button):
        ...
        try:
            ...
            # Mapas Stumble com imagens (usando URLs de exemplo)
            STUMBLE_MAPS = [
                {"name": "Block Dash", "emoji": "🏃", "image": "https://i.imgur.com/8XxJt7z.png"},
                {"name": "Block Dash Legendary", "emoji": "⭐", "image": "https://i.imgur.com/8XxJt7z.png"},
...
class MapActionModal(Modal):
    def __init__(self, parent_view, option_index: int, 
        ...
        self.image_input = TextInput(
            ...
            placeholder="Deixe vazio para remover a imagem",
            style=discord.TextStyle.short,
            max_length=500,
            required=False
        )
