# ============================================================
# EMBED_BUILDER.PY - PAINEL MODERNO v8.0 (COMPLETO)
# ============================================================
...
# ============================================================
# VIEW - COPIAR URL (REUTILIZÁVEL)
# ============================================================

class CopyUrlView(View):
    """View com botão para copiar URL"""
    __slots__ = ("url",)
    ...
    async def open_button(self, interaction: discord.Interaction, button: Button):
        ...
        # O Discord não permite abrir URL diretamente via interação
        # Então enviamos a URL para o usuário copiar
        await interaction.response.send_message(
    ...
    def build_options_embed(self) -> discord.Embed:
        ...
        embed = discord.Embed(
            ...
            description=(
                ...
                "2️⃣ **Upload:** Use o comando `/upload` ou o botão **📤 Upload**\n\n"
                "✅ **URLs que funcionam:**\n"
