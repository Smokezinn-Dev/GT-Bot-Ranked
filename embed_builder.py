# ============================================================
# EMBED_BUILDER.PY - PAINEL MODERNO v9.1 (COMPLETO)
# ============================================================
...
# ============================================================
# VIEW - PAINEL DE OPÇÕES (CORRIGIDO)
# ============================================================
...
class OptionsPanelView(View):
    ...
    async def select_option(self, interaction: discord.Interaction, select: Select):
        """CORRIGIDO: Agora abre o modal diretamente sem causar InteractionResponded"""
        ...
        # 🔥 CORREÇÃO: Abre o modal diretamente como resposta
        # Não tenta editar a mensagem primeiro para evitar InteractionResponded
