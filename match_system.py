# ============================================================
# MATCH_SYSTEM.PY - LISTA VERTICAL DE MAPAS + CONTADORES
# ============================================================
...
class MapSelectView(View):
    ...
    async def update_options(self, interaction: discord.Interaction):
        """Atualiza as opções do dropdown com os contadores atuais"""
        # Pega os mapas configurados
        settings = get_guild_settings(self.guild_id)
        maps = settings.get("ranked", {}).get("maps", ["Arena", "Castelo", "Floresta", "Deserto"])
        
        # Cria novas opções com contadores
        options = []
    ...
    async def map_select(self, interaction: discord.Interaction, select: Select):
        ...
        # Busca quantos jogadores estão na fila deste mapa
...
class TicketPanelView(View):
    ...
    async def open_ticket(self, interaction: discord.Interaction, button: Button):
        ...
        # Criação do ticket via view separada
...
class MatchSystem:
    ...
    def __init__(self, db, config, bot):
        ...
        self.map_queues: Dict[str, Dict[str, Dict[str, List[str]]]] = {}  # guild_id -> map_name -> match_type -> [user_ids]
    ...
    def get_queue_count(self, guild_id: str, map_name: str, match_type: str = None) -> int:
        """Retorna quantos jogadores estão na fila de um mapa específico"""
    ...
    def get_all_map_counts(self, guild_id: str, match_type: str = None) -> Dict[str, int]:
        """Retorna contagem de jogadores por mapa para um tipo específico"""
    ...
    def add_to_queue(self, guild_id: str, map_name: str, match_type: str, user_id: str):
        """Adiciona um jogador à fila de um mapa"""
    ...
    def remove_from_queue(self, guild_id: str, map_name: str, match_type: str, user_id: str):
        """Remove um jogador da fila de um mapa"""
        try:
