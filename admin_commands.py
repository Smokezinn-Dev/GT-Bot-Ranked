...
# ============================================================
# - Poucos estados em memória
# - Permissões por role configurável
# - Config 100% por servidor
# ============================================================
...
def _is_config_admin(member: discord.Member, settings: dict) -> bool:
    ...
    return bool(user_roles & (admin_roles | config_roles))
...
class AdminCommands(commands.Cog):
    ...
    # ============================================================
    # ECONOMIA ADMIN (compatível com Moderação)
    # ============================================================
...
async def setup(bot):
    # setup é chamado pelo main com match_system e ranking_system injetados
    pass
